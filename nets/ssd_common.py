...
def tf_ssd_bboxes_select_layer(predictions_layer, localizations_layer,
    ...
    """
    select_threshold = 0.8 if select_threshold is None else select_threshold
        ...
        for c in range(0, num_classes): #num_classes
            if c != ignore_class:
               ...
               # print(np.shape(scores))
                ...
                #bboxes = localizations_layer * tf.expand_dims( tf.transpose(fmask) ,axis = -1)
