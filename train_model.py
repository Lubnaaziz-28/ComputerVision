...
sys.path.insert(1, 'C:/Users/AN COMPUTER/SSD_tensorflow_VOC')
from preparedata import PrepareData
#from nets.ssd import g_ssd_model
from nets.proposed_ssd import g_ssd_model
...
#         self.debug_training(sess,global_step)
    ...
    def run(self):
        ...
        self.train_dir = './pssd_logs'
        
        
        self.checkpoint_path = 'C:/Users/AN COMPUTER/data/trained_models/vgg16/vgg_16.ckpt'#../data/trained_models/vgg16/vgg_16.ckpt'
        ...
        if self.fine_tune_vgg16:  
            ...
            self.train_dir = './pssd_logs/finetune'
