...
class EvaluateModel(PrepareData):
    ...
    def __setup_eval(self):
        ...
        if self.eval_train:
            ...
            self.eval_dir = 'C:/Users/AN COMPUTER/data/trained_models/tfmodel/logs/evals/train_data'
        else:
            image, _, glabels,gbboxes,gdifficults, _, _, _ = self.get_voc_2007_test_data()
            self.eval_dir = 'C:/Users/AN COMPUTER/data/trained_models/tfmodel/logs/evals/test_data'
...
#         print_filename_op = tf.Print(filename, [filename], "input images: ")
    ...
    def parse_param(self):
        ...
        self.checkpoint_path = 'C:/Users/AN COMPUTER/data/trained_models/tfmodel/logs/'
        self.finetune = args.finetune
        if args.finetune:
            self.checkpoint_path = 'C:/Users/AN COMPUTER/data/trained_models/tfmodel/logs/finetune/'
        if args.checkpoint != "":
